...
${Plot.plot({
  ...
  <p style="margin-bottom: 15px; width: 100%; max-width: 100%; box-sizing: border-box;">
  <b>RECOMMENDATION:</b> Considering the candidate has considerably less support in high income neighborhoods and there are similar concerns around policy stances across the map, the campaign should make a concerted effort to address the concerns in all the neighborhoods and focus on improving the event attendance numbers in middle and high income areas.  
  </p>
</div>
